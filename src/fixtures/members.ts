...
export const MEMBERS: readonly MemberEntity[] = [
  ...
  { id: 19, name: 'Diplomat Renata Silva', displayName: 'Renata Silva', kind: 'player', status: 'active', avatarUrl: avatar(19), departmentIds: [3, 1], roleIds: [9], controllerName: 'renatas', controllerEmail: 'renatas@example.test' },
