...
import design_1 from '@/designs/atelier'
import design_2 from '@/designs/contract-probe'
...
export const DESIGNS: Record<DesignKey, DesignDefinition> = {
  "obsidian": eraseConfig(design_0),
  "atelier": eraseConfig(design_1),
  "contract-probe": eraseConfig(design_2),
}
